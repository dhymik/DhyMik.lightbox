        ...
        var Lightbox = /*#__PURE__*/function () {
            function Lightbox($element, config) {
                ...
                if (this._galleryName) {
                    ...
                    if (this._config.showArrows && this._$galleryItems.length > 1) {
                        ...
                        _this._$modalArrows.find('a').addClass('init');
                        ...
                        this._$modalNavLayer.find('a:first-child').hover(function () {
                            ...
                            _this._$modalArrows.find('a:first-child')
                                .removeClass('hover')
                                .filter('[class=""]')
                                .removeAttr('class');
                        });
                        ...
                        this._$modalNavLayer.find('a:last-child').hover(function () {
                            ...
                            _this._$modalArrows.find('a:last-child')
                                .removeClass('hover')
                                .filter('[class=""]')
                                .removeAttr('class');
                        });
            ...
            _createClass(Lightbox, [{
                ...
                value: function _showYoutubeVideo(remote, $containerForElement) {
                    ...
                    return this._showVideoIframe("//www.youtube.com/embed/".concat(id, (id.includes("?") ? "&" : "?") + "badge=0&autoplay=1&html5=1").concat(query), width, height, $containerForElement);
                }
            }, {
                key: "_showVimeoVideo",
